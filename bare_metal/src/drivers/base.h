...
#define TIM4_OFFSET (0x00000800)
#define TIM4 (APB1_PERIPHERAL + TIM4_OFFSET)

#define TIM3_OFFSET (0x00000400)
...
#define DMA2_OFFSET (0x00026400)
#define DMA2 (AHB1_PERIPHERAL + DMA2_OFFSET)

#define DMA1_OFFSET (0x00026000)
#define DMA1 (AHB1_PERIPHERAL + DMA1_OFFSET)

// #define FLASH_INTERFACE_REG_OFFSET (0x00023C00)
